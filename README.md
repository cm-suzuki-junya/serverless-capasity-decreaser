...
```bash
serverless-capasity-decreaser$ sam build --use-container
```
...
```bash
serverless-capasity-decreaser$ sam local invoke HelloWorldFunction --event events/event.json
```
...
```bash
serverless-capasity-decreaser$ sam logs -n HelloWorldFunction --stack-name "serverless-capasity-decreaser" --tail
```
...
```bash
serverless-capasity-decreaser$ pip install -r tests/requirements.txt --user
# unit test
serverless-capasity-decreaser$ python -m pytest tests/unit -v
# integration test, requiring deploying the stack first.
# Create the env variable AWS_SAM_STACK_NAME with the name of the stack we are testing
serverless-capasity-decreaser$ AWS_SAM_STACK_NAME="serverless-capasity-decreaser" python -m pytest tests/integration -v
```
...
```bash
sam delete --stack-name "serverless-capasity-decreaser"
```
